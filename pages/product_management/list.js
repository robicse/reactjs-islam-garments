...
const TableList = observer(() => {
  ...
  const endpoint = {
    ...
    sizesUrl: `${baseUrl}/product_size_active_list`,
    unitUrl: `${baseUrl}/product_unit_active_list`,
    subunitUrl: `${baseUrl}/product_sub_unit_active_list`,
    categoryUrl: `${baseUrl}/product_category_active_list`,
