...
import Edit from "../../components/admin/product_sub_unit/edit";
import Create from "../../components/admin/product_sub_unit/create";
...
const title = "Product Sub Unit";
const subject = "Product Sub Unit";
const endpoint = {
  list: "product_sub_unit_list",
  create: "product_sub_unit_create",
  edit: "product_sub_unit_edit",
  delete: "product_sub_unit_delete",
};
