...
import Create from "../../components/admin/staff/create";
...
const  StafList = observer(() => {
  ...
  const columns = [
    ...
    //   <Avatar alt='o' src={`${webUrl}/uploads/employees/${rowData.image}`} onClick={()=>handleOpenUploadModal(rowData.id)}/>
    //   </Tooltip>),  },
    ...
    { title: 'Present Address', field: 'present_address' },
    { title: 'Permanent Address Address', field: 'permanent_address' },
